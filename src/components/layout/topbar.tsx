  ...
  return (
    <div className="flex h-full items-center gap-4 px-4">
      <div className="flex min-w-[240px] items-center gap-3 rounded-2xl border border-cyan-300/10 bg-slate-950/35 px-4 py-3 text-cyan-200 shadow-neon">
        <Sparkles size={18} />
        <div>
          <div className="text-xs uppercase tracking-[0.22em] text-textMuted">Realtime Hub</div>
          <div className="text-sm font-medium text-textMain">Cyber Control Surface</div>
        </div>
      </div>
      ...
      <div className="relative mx-2 flex-1" style={{ WebkitAppRegion: 'no-drag' } as CSSProperties}>
        ...
        <input
          ...
          placeholder="Search account / username / country"
      ...
      <button className="relative flex h-12 w-12 items-center justify-center rounded-2xl border border-white/10 bg-slate-950/40 text-slate-200 transition hover:border-neon/40 hover:text-white hover:shadow-neon" style={{ WebkitAppRegion: 'no-drag' } as CSSProperties}>
        <Bell size={18} />
      ...
      <button className="flex h-12 w-12 items-center justify-center rounded-2xl border border-white/10 bg-slate-950/40 text-slate-200 transition hover:border-neon/40 hover:text-white hover:shadow-neon" style={{ WebkitAppRegion: 'no-drag' } as CSSProperties}>
        <Settings size={18} />
      </button>
      ...
      <div className="flex items-center gap-3 rounded-2xl border border-white/10 bg-slate-950/40 px-3 py-2.5" style={{ WebkitAppRegion: 'no-drag' } as CSSProperties}>
        ...
        <div>
          ...
          <div className="text-xs text-textMuted">Enterprise Admin</div>
        </div>
      </div>
    </div>
  )
