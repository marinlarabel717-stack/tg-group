...
const SkeletonRow = memo(function SkeletonRow({ columns }: { columns: number }) {
  return (
    <div className="grid min-h-[60px] shrink-0 animate-pulse items-center gap-0 rounded-[10px] bg-panel px-0 py-0" style={ACCOUNT_GRID_STYLE}>
    ...
    <div className="space-y-5 contain-layout">
      ...
      <GlassPanel className="p-0">
        <div className="min-w-0">
          <div ref={parentRef} className="virtual-scroll-shell min-w-0 max-h-[608px] overflow-y-auto overflow-x-hidden" onWheel={handleViewportWheel}>
          ...
          {!tableLoading && rows.length === 0 ? (
            ...
            <div className="border-t border-white/5 px-3 pb-3 pt-2">
              <div
                ref={scrollBarRef}
                className="account-table-scrollbar h-4 overflow-x-auto overflow-y-hidden"
