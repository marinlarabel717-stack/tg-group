...
export class AccountUpdateService {
  ...
  async buildSuccessProfile(args: {
    ...
    const profile = {
      ...
      freeze_since_date: args.status === 'frozen' ? args.freezeSince ?? args.account.profile.freeze_since_date ?? null : null,
      freeze_until_date: args.status === 'frozen' ? args.freezeUntil ?? args.account.profile.freeze_until_date ?? null : null,
      freeze_appeal_url: args.status === 'frozen' ? args.freezeAppealUrl ?? args.account.profile.freeze_appeal_url ?? null : null,
